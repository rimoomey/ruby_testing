...
describe NumberGame do
  ...
  describe '#initialize' do
    context 'when solution is initialized' do
      ...
      matcher :be_between_zero_and_nine do
        match { |num| num.zero? || num.positive? }
      end
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      ...
      subject(:incorrect_guess) { described_class.new(5, '6') }
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        user_input = '10'
        verified_incorrect = game_check.verify_input(user_input)
        expect(verified_incorrect).to be_nil
      end
    end
  end
