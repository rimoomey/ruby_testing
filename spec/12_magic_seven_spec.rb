...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    ...
    context 'when MagicSeven has value 6 and previous step is 9' do
      it 'returns 3' do
        random_number = 9

        result = six.subtract_random_number(random_number)
  ...
  describe '#play' do
    context 'when the random number is 10' do
      let(:magic) { described_class.new(10) }
    ...
    context 'when the random number is -6' do
      let(:magic) { described_class.new(-6) }
